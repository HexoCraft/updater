...
class BukkitChannelTest {

    @Test
    public void BukkitChannel() {
        assertSame(new BukkitChannel("255160").read().getKey(), Result.SUCCESS);
        assertSame(new BukkitChannel("000000").read().getKey(), Result.REPO_NO_RELEASES);
    }
